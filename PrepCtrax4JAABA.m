...
for exptIdx = 1:length(expt)
    ...
    % change movie.ufmf to movie.sbfmf?
    ...
    % working version of call to Converter:
%     [success,msg] = ...
%         ConvertCtrax2JAABA('inmoviefile','','intrxfile','','annfile','',...
%         'expdir','','moviefilestr','movie.ufmf','trxfilestr','trx.mat',...
%         'perframedirstr','perframe',...
%         'arenatype','None','arenacenterx',0,'arenacentery',0,...
%         'arenaradius',10,'arenawidth',123,'arenaheight',123,'roi2',[],...
%         'pxpermm',1,'fps',20,...
